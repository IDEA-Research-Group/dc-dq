...
import es.us.idea.dcdq.diagnosis.Diagnosis.calculateDeviation
import es.us.idea.dcdq.diagnosis.graph.{DMN4DQTree, Tree}
import es.us.idea.dcdq.diagnosis.graph.components.{Assessment, BRDV, DimensionMeasurement, Measurement}
